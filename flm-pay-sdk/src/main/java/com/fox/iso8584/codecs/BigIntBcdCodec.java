...
/**
 * A custom field encoder/decoder to be used with LLBIN/LLLBIN fields that contain BigIntegers in
 * BCD encoding.
 *
...
public class BigIntBcdCodec implements CustomBinaryField<BigInteger> {
  ...
  @Override
  public BigInteger decodeField(String value, String encoding) {
