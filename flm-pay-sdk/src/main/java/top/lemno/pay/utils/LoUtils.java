...
//  private static BASE64Decoder decoder = new BASE64Decoder();
  ...
  public static String encodeBufferBase64(byte[] buff) {
    return buff == null ? null : Base64Utils.encode(buff);
  }
  ...
  public static byte[] decodeBufferBase64(String s) {
    return s == null ? null : Base64Utils.decode(s);
  }
  ...
  public static String encodeBase64(byte[] s) {
    if (s == null)
      return null;
    String res = Base64Utils.encode(s);
    res = res.replace("\n", "");
    res = res.replace("\r", "");
    return res;
  }
  ...
  public static byte[] decodeBase64(byte[] buff) {
    if (buff == null)
      return null; 
    try {
      byte[] b = Base64Utils.decode(new String(buff));
